...
<header class="top-menu con row">
    ...
    <section class="article-detail table-common con row">
        ...
        <br><br>
                    ...
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt deleniti repellat aliquam quis labore est error iste obcaecati laborum illo? Distinctio dolorem quis at assumenda! Perferendis, libero earum! Ducimus, ratione!</td>
                </tr>
            </tbody>
        </table>
    </section>
